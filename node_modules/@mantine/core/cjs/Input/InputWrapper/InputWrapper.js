...
const InputWrapper = React.forwardRef((props, ref) => {
  ...
  const _error = typeof error !== "boolean" && error && /* @__PURE__ */ React__default.createElement(InputError.InputError, __spreadValues(__spreadProps(__spreadValues({}, errorProps), {
    key: "error"
  }), sharedProps), error);
