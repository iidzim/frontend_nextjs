...
const ColorInput = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Input.Input.Wrapper, __spreadProps(__spreadValues({}, wrapperProps), {
    ...
    styles: styles$1,
    unstyled
  }, /* @__PURE__ */ React__default.createElement(Popover.Popover.Target, null, /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(Input.Input, __spreadProps(__spreadValues(__spreadValues({}, others), inputProps), {
    ref,
    __staticSelector: "ColorInput",
