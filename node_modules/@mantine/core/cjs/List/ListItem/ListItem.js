...
function ListItem(_a) {
  ...
  const { icon: ctxIcon, spacing, center } = List_context.useListContext();
  const { classNames, styles: styles$1, unstyled } = styles.useContextStylesApi();
  const _icon = icon || ctxIcon;
  const { classes, cx } = ListItem_styles['default']({ spacing, center }, { classNames, styles: styles$1, unstyled, name: "List" });
